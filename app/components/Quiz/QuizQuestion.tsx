...
//   onFinish,
// }) => {
//   const [timeRemaining, setTimeRemaining] = useState(30); // Timer starts at 30 seconds
...
//       setTimeUp(true); // Display the "Time's up!" message
//       setTimeout(() => {
//         setTimeUp(false);
...
//           onNext(); 
//         }
//       }, 2000); // Show the "Time's up!" message for 2 seconds
//     }

//     return () => clearTimeout(timer); // Cleanup the timer on component unmount or re-render
//   }, [timeRemaining, selectedAnswer, onNext]);
...
//             onClick={onNext}
//             className="px-3 py-4 bg-sky-300 rounded-lg text-black min-w-[152px] w-[190px] text-base font-medium"
//             disabled={timeUp || !selectedAnswer} // Disable "Next" if no answer is selected
//           >
//             Next
//           </button>
//           <Link href="/result">
...
//         {/* Timer Display */}
//         <div className="mt-5 flex items-center justify-center text-xl font-bold text-white">
//           {timeUp ? (

  ...
  return (
    <div className="flex overflow-hidden flex-col flex-1 shrink justify-center w-full basis-0 min-w-[240px] max-md:max-w-full">
      ...
      <input
        ...
        aria-label={label}
        className="flex-1 shrink gap-1 self-stretch px-3 py-2 mt-1.5 w-full text-sm leading-none bg-white rounded-md text-black text-opacity-50 max-md:max-w-full"
      />
    </div>
  );
};